...
const std::map<TokenType, std::string> TOKEN_NAMES = {
    ...
    {TokenType::MULTIPLY_ASSIGN, "Multiply assign"},
    {TokenType::DIVIDE_ASSIGN, "Divide assign"},
    {TokenType::ADD_ASSIGN, "Add assign"},
    {TokenType::SUBTRACT_ASSIGN, "Subtract assign"},
    {TokenType::ASSIGN_EQUALS, "Assign equals"},
